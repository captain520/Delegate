...
@interface CPShopResigterParams : NSObject
...
@property (nonatomic, copy) NSString *paycfg;
@property (nonatomic, copy) NSString *licensecode;  //营业执照代码
