...
- (void)setupUI {
    ...
    if (nil == self.shopRegisterBt) {
        ...
        [self.shopRegisterBt setTitle:@"商家注册" forState:0];
    ...
    if (nil == self.assistantRegisterBt) {
        ...
        [self.assistantRegisterBt setTitle:@"代理注册" forState:0];
...
- (void)pus2ShopRegistVC {
    CPShopRegistLoginVC *vc = [[CPShopRegistLoginVC alloc] init];
    vc.registType = CPRegistTypeShop;
    vc.title = @"商家注册";
    
    [self.navigationController pushViewController:vc animated:YES];
//    [self push2VCWith:@"CPShopRegistLoginVC" title:@"商家注册"];
//    [self push2VCWith:@"CPSuccessVC" title:@"商家注册"];
}
- (void)pus2AssistantRegistVC {
    
    CPShopRegistLoginVC *vc = [[CPShopRegistLoginVC alloc] init];
    vc.registType = CPRegistTypeAssistant;
    vc.title = @"代理注册";
    
    [self.navigationController pushViewController:vc animated:YES];
}
//    [self push2VCWith:@"CPAssistantRegisterVC" title:@"代理注册"];}
